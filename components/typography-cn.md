...
https://ant.design/components/typography-cn/semantic.md
...
| fontSizeHeading1 | H1 标签所使用的字号 | string \| number |  |
| fontSizeHeading2 | h2 标签所使用的字号 | string \| number |  |
| fontSizeHeading3 | h3 标签使用的字号 | string \| number |  |
| fontSizeHeading4 | h4 标签使用的字号 | string \| number |  |
| fontSizeHeading5 | h5 标签使用的字号 | string \| number |  |
