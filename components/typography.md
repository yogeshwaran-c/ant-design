...
Makes Typography copyable with related configuration options.
...
https://ant.design/components/typography/semantic.md
...
| fontSizeHeading1 | Font size of h1 tag. | string \| number |  |
| fontSizeHeading2 | Font size of h2 tag. | string \| number |  |
| fontSizeHeading3 | Font size of h3 tag. | string \| number |  |
| fontSizeHeading4 | Font size of h4 tag. | string \| number |  |
| fontSizeHeading5 | Font size of h5 tag. | string \| number |  |
